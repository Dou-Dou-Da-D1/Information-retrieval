...
# 配置部分
URLS = [
    f'https://news.nankai.edu.cn/mtnk/system/count//0006000/000000000000/000/000/c0006000000000000000_000000{i}.shtml'
    for i in range(100, 999)
]
URLS.append('https://news.nankai.edu.cn/mtnk/index.shtml')
OUTPUT_DIR = 'pages'
