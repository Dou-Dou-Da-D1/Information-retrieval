...
# 配置部分
URLS = [
    f'https://news.nankai.edu.cn/nkdxb/system/count//0011000/000000000000/000/000/c0011000000000000000_0000000{i}.shtml'
    for i in range(10,78)
]
URLS.append('https://news.nankai.edu.cn/nkdxb/index.shtml')
OUTPUT_DIR = 'pages'
