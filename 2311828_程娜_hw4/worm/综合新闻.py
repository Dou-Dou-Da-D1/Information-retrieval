...
# 配置部分
URLS = [
    f'https://news.nankai.edu.cn/zhxw/system/count//0004000/000000000000/000/000/c0004000000000000000_000000{i}.shtml'
    for i in range(100,844)
]
URLS.append('https://news.nankai.edu.cn/zhxw/index.shtml')
OUTPUT_DIR = 'pages'
