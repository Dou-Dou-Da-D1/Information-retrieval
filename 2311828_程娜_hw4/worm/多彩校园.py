...
# 配置部分
URLS = [
    f'https://news.nankai.edu.cn/dcxy/system/count//0005000/000000000000/000/000/c0005000000000000000_000000{i}.shtml'
    for i in range(100,534)
]
URLS.append('https://news.nankai.edu.cn/dcxy/index.shtml')
OUTPUT_DIR = 'pages'
