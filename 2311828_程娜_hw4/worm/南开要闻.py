...
# 配置部分
URLS = [
    f'https://news.nankai.edu.cn/ywsd/system/count//0003000/000000000000/000/000/c0003000000000000000_000000{i}.shtml'
    for i in range(100,658)
]
URLS.append('https://news.nankai.edu.cn/ywsd/index.shtml')
OUTPUT_DIR = 'pages'
